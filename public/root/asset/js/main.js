...
if (window.location.hostname == '127.0.0.1' || window.location.hostname == 'localhost') {
  ...
  let navlist = {
    href: ['/404.html', '/about.html', '/cdn.html', '/contact.html', '/documentation.html', '/form.html', '/founder.html', '/index.html', '/invoice.html', '/maintenance.html', '/payment.html', '/privacy-policy.html', '/project.html', '/service.html', '/sitemap.html', '/template.html', '/ticket.html'],
    name: ['404', 'About', 'CDN', 'Contact', 'Documentation', 'Form', 'Founder', 'Home', 'Invoice', 'Maintenance', 'Payment', 'Privacy Policy', 'Project', 'Service', 'Sitemap', 'Template', 'Ticket'],
  }
