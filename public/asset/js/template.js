    ...
    nav.outerHTML = `<nav class="navbar navbar-expand-lg bg-light border-bottom fixed-top">
            <div class="container py-2">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link${path == "/" ? (state = active) : (state = "")}"${
        path == "/" ? (state = aria) : (state = "")
    } href="/">Home</a></li>
                        <li class="nav-item"><a class="nav-link${path == "/about/" ? (state = active) : (state = "")}"${
        path == "/about/" ? (state = aria) : (state = "")
    } href="/about/">About</a></li>
                        <li class="nav-item"><a class="nav-link${path == "/blog/" ? (state = active) : (state = "")}"${
        path == "/blog/" ? (state = aria) : (state = "")
    } href="/blog/">Blog</a></li>
                        <li class="nav-item"><a class="nav-link${path == "/career/" ? (state = active) : (state = "")}"${
        path == "/career/" ? (state = aria) : (state = "")
        ...
        path == "/hosting/" ? (state = aria) : (state = "")
    } href="/hosting/">Home</a></li>
                                <li><a class="dropdown-item${path == "/hosting/about/" ? (state = active) : (state = "")}"${
        path == "/hosting/about/" ? (state = aria) : (state = "")
    } href="/hosting/about/">About</a></li>
                                <li><a class="dropdown-item${path == "/hosting/contact/" ? (state = active) : (state = "")}"${
        path == "/hosting/contact/" ? (state = aria) : (state = "")
    } href="/hosting/contact/">Contact</a></li>
                                <li><a class="dropdown-item${path == "/hosting/pricing/" ? (state = active) : (state = "")}"${
        path == "/hosting/pricing/" ? (state = aria) : (state = "")
    } href="/hosting/pricing/">Pricing</a></li>
        ...
        path == "/project/wordpress-installer.html" ? (state = aria) : (state = "")
                                ...
                                <li class="dropdown-divider"></li>
                                <li><a class="dropdown-item${path == "/project/" ? (state = active) : (state = "")}"${
        path == "/" ? (state = aria) : (state = "")
    } href="/project/">Other</a></li>
                            </ul>
                        </li>
                        <li class="nav-item d-lg-none"><a class="nav-link${path == "/contact/" ? (state = active) : (state = "")}"${
        path == "/contact/" ? (state = aria) : (state = "")
    } href="/contact/">Contact</a></li>
                        <li class="nav-item d-none d-lg-block"><a class="btn btn-dark ms-2${path == "/contact/" ? (state = active) : (state = "")}"${
        path == "/contact/" ? (state = aria) : (state = "")
    } href="/contact/">Contact</a></li>
                    </ul>
                </div>
